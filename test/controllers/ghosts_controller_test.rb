...
class GhostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ghost" do
    assert_difference('Ghost.count') do
      post ghosts_url, params: { ghost: { description: @ghost.description, name: @ghost.name } }
    end
  ...
  test "should update ghost" do
    patch ghost_url(@ghost), params: { ghost: { description: @ghost.description, name: @ghost.name } }
