class GhostsController < ApplicationController
  ...
  # GET /ghosts.json
  def index
    @ghosts = Ghost.order(:name)
  end
  # @ vars are automatically shared with the associated view.
  # app/views/ghosts/index.html.erb
  ...
  private
    ...
    def ghost_params
      params.require(:ghost).permit(:name, :description)
    end
end
